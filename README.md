...
- **🎙️ Voice-to-Note**: Capture ideas instantly. Record audio and transcribe it locally using `whisper.cpp`, then automatically enhance the result.
...
| **Database** | SQLite3 | Private, file-based local persistence |
